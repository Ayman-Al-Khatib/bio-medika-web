import 'package:bio_medika_web/models/user_model.dart';
...
class OrderModel {
  ...
  factory OrderModel.fromJson(Map<String, dynamic> json) {
    return OrderModel(
        ...
        details: (json['details'] as List).map((detailJson) => OrderDetail.fromJson(detailJson)).toList(),
        user: UserModel.fromJson(json['pharmacist']));
  }
